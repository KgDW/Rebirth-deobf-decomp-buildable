...
extends Module {
    ...
    public final Setting<Boolean> self = this.add(new Setting<>("Self", true, v -> this.page.getValue() == Page.GLOBAL));
    public final Setting<Boolean> noInterp = this.add(new Setting<>("NoInterp", false, v -> this.page.getValue() == Page.GLOBAL));
    public final Setting<Boolean> sneak = this.add(new Setting<>("Sneak", false, v -> this.page.getValue() == Page.GLOBAL));
    ...
    private final Setting<Boolean> hide = this.add(new Setting<>("Hide", false, v -> this.page.getValue() == Page.GLOBAL).setParent());
    private final Setting<Float> range = this.add(new Setting<>("Range", 1.5f, 1.0f, 12.0f, v -> this.hide.isOpen() && this.page.getValue() == Page.GLOBAL));
